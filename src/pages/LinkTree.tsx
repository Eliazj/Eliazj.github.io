...
export default function LinkTree() {
    return (
        <div className="min-h-screen bg-[#d3c5b3] flex flex-col relative overflow-hidden font-sans text-[#1a1a1a]">
            ...
            <div className="relative z-10 flex flex-col items-center -mt-16 md:-mt-20">
                <div className="w-32 h-32 md:w-40 md:h-40 relative flex items-center justify-center">
                    {/* Placeholder for the X corn logo - using a dark styling to mimic it */}
                    <div className="absolute w-24 h-24 bg-[#1a1a1a] rotate-45 flex items-center justify-center shadow-lg">
                        <div className="text-[#A8894B] font-display font-black text-5xl -rotate-45">X</div>
                    </div>
                </div>
