    ...
    return (
        <div className="min-h-screen bg-stone-texture flex flex-col relative overflow-hidden font-sans text-bone">
            ...
            <div className="flex flex-col items-center gap-5 mt-8 px-6 relative z-10 w-full max-w-sm mx-auto">
                {[
                    { text: 'PEDIR POR WHATSAPP', url: 'https://wa.me/527201878994' },
                    { text: 'PEDIR POR UBER EATS', url: 'https://tinyurl.com/27s7ngcm' },
            ...
            <div className="flex justify-center gap-8 mt-16 pb-16 relative z-10">
                <a href="tel:+527201878994" className="w-14 h-14 rounded-full border border-white/10 flex items-center justify-center text-bone hover:text-stone-dark hover:bg-bronze hover:border-bronze transition-all duration-300 shadow-lg">
